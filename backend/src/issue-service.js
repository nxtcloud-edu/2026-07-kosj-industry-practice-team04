...
import {
  ...
  deptFor, findMergeCandidates, isValidStatus, priorityOf, selectReviewQueue, summarizeIssue,
} from './domain.js';
...
/** '나도 불편해요' — 기기당 문제별 1회 (악용 방지) */
export function addEmpathy(issueId, deviceId) {
